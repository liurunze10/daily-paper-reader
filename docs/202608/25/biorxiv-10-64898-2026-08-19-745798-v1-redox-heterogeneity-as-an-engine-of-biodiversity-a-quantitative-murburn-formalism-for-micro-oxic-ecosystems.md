...
title_zh: 氧化还原异质性作为生物多样性的引擎：微氧生态系统的定量 murburn 形式体系
authors: "Manoj, K. M., Parashar, A."
date: 2026-08-20
pdf: "https://www.biorxiv.org/content/10.64898/2026.08.19.745798v1.full.pdf"
tags: ["query:ros-mp"]
score: 6.0
evidence: 氧气作为肠道粘液层中扩散性反应物种的生成源
tldr: 本研究探讨了微氧环境中生物多样性达到峰值的机制，提出了基于murburn原理的生态形式体系。研究认为氧气不仅是代谢底物，更是通过产生扩散性活性物种引发氧化还原异质性的引擎。通过反应扩散框架和数值模拟，证明了中等氧浓度能最大化自由基场异质性，从而在无需外部生态位划分的情况下促进物种共存与多样化。
source: biorxiv
selection_source: fresh_fetch
motivation: 传统生态学理论难以解释为何中等氧气浓度环境往往具有极高的生物多样性。
method: 提出一种整合经验观察与反应扩散框架的murburn生态形式体系，模拟氧气产生的扩散性活性物种对适应度景观的影响。
result: 数值模拟显示中等氧张力能自发产生最大化的自由基场异质性，从而在微氧区实现物种共存和多样性峰值。
conclusion: 波动氧化还原界面是驱动生物多样性和适应性更替的关键生态区，宏观动物通过重塑氧梯度进一步增强了这种效应。
---

## 摘要
生物多样性通常在波动的微氧环境中达到峰值，例如海洋最低氧区界面、根际聚合体、沉积物、微生物席和肠道粘液层。然而，经典的生态学理论并不能充分解释为什么中间氧张力反复有利于物种共存和多样化。在此，我们提出了一种 murburn 生态学形式体系，其中氧气不仅作为代谢底物，还通过部分还原以及可扩散反应物种（DRS）和氧化还原中间体的形成，作为动态氧化还原异质性的生成器。通过将海洋、肠道、土壤和水生界面生态系统的经验观察与反应-扩散框架相结合，我们表明中间氧张力自然地使自由基场异质性最大化，并产生动态变化的适应度景观。数值模拟证明了在没有外部施加生态位划分的情况下，微氧区内会出现自发共存、生物多样性极大值、局部多样化以及共存稳定性。进一步的模拟表明，水生大型动物通过重构氧梯度并产生生态系统尺度的扩散氧化还原架构（ESDRA），间接地增强了生物多样性。该框架提出，波动的氧化还原界面在不同生物尺度上充当了具有高适应性更替潜力的生态区。
