...
## 摘要
巨噬细胞必须根据感染轨迹调整炎症规模，随病原体载量上升而升级，随其下降而消退。细胞因子 IL-10 及其染色质水平效应因子 BCL-3 是至关重要的抗炎因子，但它们如何避免在这些新招募的细胞读取自身的病原体输入之前就将其静默，目前尚不清楚。通过对骨髓来源的巨噬细胞应用系统变化的连续 TLR4（Kdo2-Lipid A）刺激，我们发现了两个耦合特征。首先，巨噬细胞保留了先前刺激的定量记忆：只有当二次 TLR 刺激达到或超过前一次刺激时，IκB 降解、NF-κB/MAPK 激活和细胞因子输出才会增加。其次，IL-10 的敏感性本身受 TLR4 历史的门控：即使是 100 倍过量的 IL-10 也无法抑制弱启动细胞中的 TNF-α。这两者都追溯到依赖于历史和 IL-10 的 BCL-3 招募，以及 Tnf κB 位点的 p65 置换。模型显示了这种许可逻辑如何实现感知轨迹的反应，从而在清除病原体的同时限制组织损伤。
