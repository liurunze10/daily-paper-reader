---
title: "A eutherian-specific metaviral gene, RTL6, coordinates microglial inflammatory responsiveness and state regulation"
title_zh: 真兽类特有的元病毒基因 RTL6 协调小胶质细胞的炎症反应性与状态调节
authors: "Ishino, F., Irie, M., Shiura, H., Kohda, T., Kaneko-Ishino, T."
date: 2026-07-16
pdf: "https://www.biorxiv.org/content/10.64898/2026.07.15.738833v1.full.pdf"
tags: ["query:ros-mp"]
score: 6.0
evidence: 小胶质细胞炎症反应及状态调节
tldr: 本研究探讨了胎盘类哺乳动物特有的元病毒衍生基因RTL6在小胶质细胞中的功能。通过对Rtl6缺失的小胶质细胞进行转录组分析，发现RTL6不仅介导LPS清除，还调节TLR4信号通路及炎症基因的早期诱导。研究证明RTL6能耦合细胞外感知与炎症响应，并抑制小胶质细胞向疾病相关状态转变，是调节其功能状态的关键因子。
source: biorxiv
selection_source: fresh_fetch
figures_json: "[{\"url\": \"assets/figures/biorxiv/biorxiv-10-64898-2026-07-15-738833-v1/fig-001.webp\", \"caption\": \"Table 1A\", \"page\": 27, \"index\": 1, \"width\": 968, \"height\": 1496}]"
motivation: 旨在阐明胎盘类哺乳动物特有基因RTL6在小胶质细胞TLR4信号传导及炎症反应中的具体调节机制。
method: 利用RNA-seq技术对比分析了野生型和Rtl6缺失的小胶质细胞在LPS刺激后的早期转录组差异。
result: RTL6缺失显著减弱了炎症早期反应基因的表达，并导致细胞周期及疾病相关小胶质细胞（DAM）基因的协同上调。
conclusion: RTL6是连接细胞外病原体感知与炎症转录响应的关键调节因子，在维持小胶质细胞稳态中发挥重要作用。
---

## 摘要
RTL6（也称为 SIRH3）是一种真兽类特有的元病毒衍生基因，在有胎盘哺乳动物中高度保守。我们此前证明，RTL6 在小胶质细胞中表达并分泌到大脑细胞外间隙，并在那里介导细菌脂多糖（LPS）的捕获和清除。然而，其在小胶质细胞 TLR4 信号传导中的作用尚不清楚。为了研究最早的 LPS 反应，我们对 LPS 刺激 10 分钟后的野生型和 Rtl6 缺陷型原代小胶质细胞进行了 RNA-seq 分析。Rtl6 缺陷型小胶质细胞表现出源自 Rtl6 非翻译区的残留转录本的代偿性上调，提示 Rtl6 表达存在反馈调节。RTL6 的缺失减弱了即刻早期反应基因（包括 Fos、Jun、Nr4a1、Nr4a2、Egr2 和 Egr3）的诱导，并广泛抑制了干扰素反应性和炎症转录程序。神经元和少突胶质细胞/髓鞘相互作用通路的改变表明小胶质细胞通讯网络发生了重塑。显著的是，参与细胞周期进程、DNA 复制、染色质组装、DNA 修复和基因组维持的基因被协调上调，其中包括多个疾病相关小胶质细胞（DAM）相关基因。总之，这些发现表明 RTL6 将细胞外 LPS 感知与炎症转录反应耦合，同时调节小胶质细胞的功能状态转换。我们的结果确定 RTL6 是有胎盘哺乳动物中控制小胶质细胞功能状态的调节网络中一个此前未被认识的组成部分。
