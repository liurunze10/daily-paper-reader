...
tags: ["query:ros-mp"]
score: 7.0
evidence: 描绘巨噬细胞的动态细胞状态和代谢对话
tldr: 本研究通过对比皮肤伤口愈合与皮肤鳞状细胞癌的单细胞转录组数据，揭示了伤口相关巨噬细胞（WAMs）与肿瘤相关巨噬细胞（TAMs）的动态差异。研究发现，TAMs 具有异常的脂质代谢特征，且这种状态受 SOX2 高表达的肿瘤起始干细胞调控。这一发现为通过阻断代谢对话来优化癌症免疫治疗提供了新策略。
source: biorxiv
...
motivation: 旨在阐明生理性组织再生与病理性肿瘤生长过程中，巨噬细胞程序在分子与功能层面的关键差异。
method: 利用单细胞转录组测序技术对比分析皮肤伤口愈合与皮肤鳞状细胞癌进展中巨噬细胞的动态细胞状态。
result: 发现脂质代谢异常是 TAMs 的显著特征，且 SOX2 高表达的肿瘤起始干细胞是驱动 TAMs 代谢重塑的关键因素。
conclusion: 阻断肿瘤起始干细胞与巨噬细胞间的代谢通讯是改善髓系细胞功能并增强癌症免疫治疗效果的潜在策略。
---
