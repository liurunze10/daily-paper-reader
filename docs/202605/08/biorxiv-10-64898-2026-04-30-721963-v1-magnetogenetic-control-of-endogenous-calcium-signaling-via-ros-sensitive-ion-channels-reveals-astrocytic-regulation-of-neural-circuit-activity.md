---
title: Magnetogenetic control of endogenous calcium signaling via ROS-sensitive ion channels reveals astrocytic regulation of neural circuit activity
title_zh: 通过ROS敏感离子通道对内源性钙信号的磁遗传学控制揭示了星形胶质细胞对神经回路活动的调节
authors: "HERNANDEZ-MORALES, M., Morales-Zuniga, J., Tran, T., Han, V., Tjahjono, N., Natan, R. G., Li, Y., Tian, L., Ji, N., Liu, C."
date: 2026-05-05
pdf: "https://www.biorxiv.org/content/10.64898/2026.04.30.721963v1.full.pdf"
tags: ["query:ros-mp"]
score: 6.0
evidence: 通过活性氧敏感离子通道对钙信号进行磁遗传控制
tldr: 本研究针对星形胶质细胞在神经回路中功能不明的问题，开发了磁遗传学工具pmFeRIC。该工具通过磁场触发内源性铁蛋白产生局部活性氧，激活ROS敏感通道以诱导钙信号。实验证明，选择性激活星形胶质细胞钙信号能显著增强海马神经元的突触传递和回路活动，且其在体内的动力学特征与生理状态相似。这一成果确立了星形胶质细胞钙信号对神经回路的调节作用，并提供了一种非侵入式的无线控制新平台。
source: biorxiv
selection_source: fresh_fetch
motivation: 由于缺乏能够模拟生理性星形胶质细胞钙信号的工具，星形胶质细胞对神经回路功能的因果贡献一直难以确定。
method: 开发了磁遗传学工具pmFeRIC，利用磁场和内源性铁蛋白在细胞膜产生局部活性氧，进而激活ROS敏感离子通道并诱导钙内流。
result: 实验发现磁激活星形胶质细胞钙信号可增强突触释放概率和谷氨酰胺能传递，且在体内能实现与运动诱导活动动力学相似的控制。
conclusion: 研究证实了内源性星形胶质细胞钙信号足以调节神经回路功能，并为无线、按需控制细胞特异性内源钙信号提供了通用平台。
---

## 摘要
星形胶质细胞表现出复杂的钙信号传导，被认为能够检测、整合并调节神经元活动；然而，它们对神经回路功能的因果贡献仍未得到解决。这在一定程度上是由于缺乏能够重现生理性星形胶质细胞钙信号的工具。在此，我们展示了对星形胶质细胞内源性钙信号的实验性磁控制足以调节神经回路动力学。利用pmFeRIC（一种用于远程、非侵入性和按需激活内源性钙通路的磁遗传学工具），我们证明了选择性激活星形胶质细胞钙信号可驱动神经元活动。pmFeRIC利用磁场和内源性铁蛋白在质膜产生局部的活性氧（ROS），激活天然的ROS敏感离子通道，从而诱导钙离子内流。在体外海马回路中，内源性星形胶质细胞钙信号的磁激活产生了稳健的、状态依赖性的神经元回路活动变化，部分原因是通过增加突触前释放概率、突触后爆发式放电和谷氨酸能传递。这些效应由瞬时受体电位通道介导，由细胞内钙库放大，并在星形胶质细胞钙信号被破坏时消失，从而确立了其在神经回路动力学中的因果作用。在体内，pmFeRIC以与运动诱导活动相当的动力学激活星形胶质细胞中的内源性钙信号，从而能够控制类似于生理行为反应的星形胶质细胞钙动力学。总之，这些发现证实了内源性星形胶质细胞钙信号足以调节神经回路功能，并引入了一个广泛适用的平台，通过磁激活ROS敏感离子通道，实现细胞特异性、无线、按需控制内源性钙信号。
