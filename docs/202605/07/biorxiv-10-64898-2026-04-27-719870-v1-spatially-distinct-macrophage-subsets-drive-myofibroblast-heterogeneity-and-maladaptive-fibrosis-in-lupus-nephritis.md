...
title_zh: 空间上截然不同的巨噬细胞亚群驱动狼疮性肾炎中的肌成纤维细胞异质性和不良纤维化
authors: "Raparia, C., Hoover, P., Ai, J., Clark, M., Shah, S., Accelerating Medicines Partnership (AMP) RA/SLE Network,, diamond, b., Hacohen, N., Arazi, A., Davidson, A. N."
date: 2026-04-30
pdf: "https://www.biorxiv.org/content/10.64898/2026.04.27.719870v1.full.pdf"
tags: ["query:ros-mp"]
score: 6.0
evidence: 不同的巨噬细胞亚群驱动狼疮性肾炎中的肌成纤维细胞异质性
tldr: 本研究通过单细胞测序和空间转录组学分析了狼疮性肾炎（LN）中巨噬细胞与成纤维细胞的相互作用。研究发现了两种空间分布不同的肌成纤维细胞亚群（Myofib1和Myofib2），分别受常驻巨噬细胞和浸润性巨噬细胞驱动，揭示了导致肾脏纤维化的特定炎症回路，为预防慢性肾损伤提供了潜在治疗靶点。
source: biorxiv
selection_source: fresh_fetch
motivation: 旨在探究狼疮性肾炎中免疫细胞与基质细胞之间的相互作用，以揭示导致肾脏纤维化和功能衰退的机制。
method: 利用156例人类LN活检样本的单细胞RNA测序、空间转录组学分析以及小鼠模型体外共培养实验进行验证。
result: 鉴定出分布在肾小管间质的促炎性Myofib1和分布在肾小球的纤维化Myofib2亚群，并明确了它们与不同巨噬细胞亚群的空间共定位及配体-受体相互作用。
conclusion: 研究揭示了LN中巨噬细胞-成纤维细胞互作的空间和功能异质性，为干预肾脏纤维化提供了新的分子靶点。
---

## 摘要
目的：狼疮性肾炎 (LN) 是系统性红斑狼疮 (SLE) 的严重并发症，会导致进行性肾纤维化和功能下降。为了开发有效的治疗策略，需要了解免疫细胞与基质细胞之间的相互作用。在此，我们研究了人类 LN 中巨噬细胞与成纤维细胞相互作用的图谱，并在小鼠模型中验证了这些发现。方法：我们利用来自 AMP-SLE 队列的 156 例人类 LN 活检样本和 30 例健康对照的单细胞 RNA 测序 (scRNAseq)，以及 6 例 LN 患者活检样本的空间转录组学，表征了不同的成纤维细胞亚群及其与肾巨噬细胞的相互作用。通过小鼠模型的体外共培养研究，进一步确定了这些相互作用的功能后果。结果：我们鉴定了两个肌成纤维细胞亚群：富集在肾小管间质的促炎亚群 (Myofib1) 和位于肾小球的纤维化/重塑亚群 (Myofib2)，两者均与组织学慢性指数相关。空间转录组学揭示了不同的共定位模式，Myofib1 与激活的常驻巨噬细胞 (RM) 亚群相互作用，而 Myofib2 与肾小球浸润的疾病相关巨噬细胞相互作用。体外共培养研究表明，肾炎 RM 促进促炎、重塑的成纤维细胞表型，从而损害伤口愈合并驱动类 Myofib1 基因程序，而疾病相关巨噬细胞则产生具有修复能力失调的促纤维化成纤维细胞。细胞间通讯分析确定了介导这种跨界通讯的关键配体-受体相互作用，包括 Spp1/整合素、Sema4/PlexinB 和 NAMPT/INSR。结论：我们的数据揭示了 LN 中巨噬细胞-成纤维细胞跨界通讯在空间和功能上的异质性图谱。这些发现增进了我们对 LN 肾纤维化发生的理解，突出了可能作为预防慢性肾损伤治疗靶点的特定纤维化-炎症回路。
