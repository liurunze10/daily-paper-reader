---
title: Transient efferocytosis-induced activation of IKKβ reprograms macrophages to promote tissue resolution
title_zh: 胞葬作用诱导的 IKKβ 瞬时激活重编程巨噬细胞以促进组织消退
authors: "Ngai, D., Chowdhury, S., Kuriakose, G., Havens, B., Sukka, S. R., Yalcinkaya, M., Frey, J. M., Doviak, H., Bradford, J. W., Dorweiler, B., Winter, H., Maegdefessel, L., Walsh, K., Thaler, J. P., Tall, A. R., Tabas, I."
date: 2026-04-30
pdf: "https://www.biorxiv.org/content/10.64898/2026.04.27.720940v1.full.pdf"
tags: ["query:ros-mp"]
score: 8.0
evidence: 胞葬作用将巨噬细胞重编程为修复表型
tldr: 本研究发现巨噬细胞在胞葬过程中通过MerTK受体瞬时激活IKKβ，从而启动组织修复。这一通常与炎症相关的信号通路通过NFκB和p38-STAT3链条，激活IL-10产生及Treg扩增等促修复路径。在胸腺损伤和动脉粥样硬化模型中，缺失IKKβ会显著阻碍修复。该研究揭示了胞葬诱导修复的统一上游信号，为优化抗炎治疗提供了新思路。
source: biorxiv
selection_source: fresh_fetch
motivation: 旨在探索胞葬作用诱导巨噬细胞向促修复表型转变是否存在共同的上游触发机制。
method: 利用体外实验及胸腺损伤和动脉粥样硬化小鼠模型，研究了巨噬细胞IKKβ在组织修复中的作用及其分子机制。
result: 证实了MerTK介导的IKKβ瞬时激活是启动IL-10产生、持续胞葬及Treg扩增等多个促修复路径的核心。
conclusion: IKKβ信号轴是胞葬诱导组织修复的关键统一信号，提示在开发抗炎药物时需注意避免干扰该修复路径。
---

## 摘要
巨噬细胞对凋亡细胞的清除（称为胞葬作用，efferocytosis）可将巨噬细胞重编程为消退/修复表型，而胞葬作用的病理性缺陷会驱动许多慢性炎症性疾病。先前的研究已经阐明了由胞葬作用激活的众多下游促消退通路，但这些通路是否存在共同的上游触发因素仍不清楚。在此，我们报道了进行胞葬作用的巨噬细胞出人意料地利用一种通常与炎症相关的信号模块，在组织消退中发挥这一关键的启动作用。凋亡细胞与 MerTK 受体的结合触发了核因子 (NF) κB 激酶抑制剂亚基 β (IKKβ) 的快速且瞬时的激活，导致 NFκB 和 p38-信号转导及转录激活因子 3 (STAT3) 信号传导，进而激活多个关键的下游促消退通路，包括白细胞介素-10 (IL-10) 的产生、持续的胞葬作用以及调节性 T (Treg) 细胞的扩增。上游 IKKβ 通路与下游消退通路通过几种中间分子相联系，包括转录因子 Myc、表观遗传修饰因子 ten-eleven translocation-2 (TET2) 以及免疫检查点蛋白程序性死亡配体 1 (PD-L1)。在体内缺失巨噬细胞 IKKβ 会阻断上述消退通路，并在两种胞葬作用介导的修复场景中损害组织修复：地塞米松诱导胸腺细胞凋亡后的胸腺损伤消退；以及最重要的一点，由降低低密度脂蛋白 (LDL) 诱导的动脉粥样硬化消退，这与人类心血管疾病的预防高度相关。这些发现阐明了胞葬作用诱导的消退存在统一的上游信号，这可能提示新的治疗策略，以增强多种组织消退通路，并通过避免阻断 IKKβ-NFκB/p38 介导的消退来优化抗炎治疗。
