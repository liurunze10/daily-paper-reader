...
title_zh: 通过基因编码的氧化化学调节蛋白质功能
authors: "Li, H., Pavlic, A., Ibrahim, N. E., Wu, D., Shapiro, M. G."
date: 2026-05-11
pdf: "https://www.biorxiv.org/content/10.1101/2025.11.06.686050v2.full.pdf"
tags: ["query:ros-mp"]
score: 6.0
evidence: 利用miniSOG产生ROS的遗传编码氧化化学
tldr: 本研究开发了一种基于基因编码氧化化学的可编程蛋白质调节框架。利用光敏蛋白miniSOG在特定细胞环境下产生响应性活性氧，实现了对氧化还原报告蛋白和TRP离子通道的精确控制。该方法具有高度的空间组织性和定量可调性，可通过光照参数和亚细胞定位优化调节效果，为在活细胞中工程化调节蛋白质功能提供了通用的新手段。
source: biorxiv
selection_source: fresh_fetch
motivation: 氧化化学在内源性信号通路中至关重要，但作为一种可编程的策略来调节活细胞中的蛋白质功能尚未得到充分利用。
method: 通过基因编码光敏蛋白miniSOG产生可控的活性氧，并结合特定的细胞内环境和亚细胞定位来调节目标蛋白。
result: 成功实现了对氧化还原报告蛋白HyPerRed的荧光增强以及对TRPA1和TRPV1离子通道的选择性激活，且调节过程具有高度可调性。
conclusion: 该研究建立了一个通用的、空间组织的基因编码氧化化学框架，为在活细胞中工程化调节蛋白质功能提供了新方法。
---

## 摘要
氧化化学是许多内源性信号通路的基础，但作为一种在活细胞中调节蛋白质功能的可编程策略，其应用仍未得到充分开发。在此，我们通过将光敏剂与特定的细胞内环境耦合，建立了基因编码的氧化化学作为一种可调控框架，用于调节多种蛋白质。利用 miniSOG 产生活性氧（ROS），我们证明受控的细胞内氧化会增强氧化还原报告蛋白 HyPerRed 的荧光，并激活氧化还原敏感的 TRP 离子通道，其中 TRPA1 和 TRPV1 反应强烈，而 TRPV4 则没有。通路选择性清除剂揭示了可溶性靶点和膜靶点与不同氧化过程的差异化耦合，支持了基于环境而非统一氧化扰动的选择性。调节强度和动力学可通过光照参数、表达比例和亚细胞定位进行定量调节，其中膜靶向增强了与膜效应器的耦合。最后，将 miniSOG 融合靶向至 TRPV1 以及对人成纤维细胞中内源性 TRPA1 的调节，将该方法扩展到了蛋白质近端和天然细胞环境。总之，这些结果将基因编码的氧化化学定位为一种多功能且具有空间组织性的模式，用于在定义的运行机制内工程化活细胞中的蛋白质功能。
