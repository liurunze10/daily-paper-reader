---
title: Modulating Protein Function through Genetically Encoded Oxidative Chemistry
title_zh: 通过遗传编码的氧化化学调节蛋白质功能
authors: "Li, H., Pavlic, A., Ibrahim, N. E., Wu, D., Shapiro, M. G."
date: 2026-05-11
pdf: "https://www.biorxiv.org/content/10.1101/2025.11.06.686050v2.full.pdf"
tags: ["query:ros-mp"]
score: 7.5
evidence: 使用miniSOG产生活性氧(ROS)以调节蛋白质功能
tldr: 本研究开发了一种基于基因编码氧化化学的可调控框架，用于在活细胞中调节蛋白质功能。通过利用光敏蛋白miniSOG产生反应性氧物种（ROS），研究者成功实现了对氧化还原报告蛋白HyPerRed和TRP离子通道（如TRPA1和TRPV1）的精确控制。该方法通过光照参数、表达比例和亚细胞定位实现定量调节，为在原生细胞环境中空间化、程序化地操纵蛋白质功能提供了新工具。
source: biorxiv
selection_source: fresh_fetch
motivation: 尽管氧化化学在内源性信号传导中至关重要，但其作为一种可编程的策略来调节活细胞内蛋白质功能的方法尚未得到充分利用。
method: 通过基因编码光敏蛋白miniSOG产生受控的活性氧（ROS），并结合亚细胞定位和光照参数来调节目标蛋白的氧化状态。
result: 成功激活了氧化还原报告蛋白及特定的TRP离子通道，并证明了通过改变膜定位和光照强度可以定量调节调制强度与动力学。
conclusion: 基因编码氧化化学是一种通用且具有空间组织性的手段，能够在定义的运行机制内实现对活细胞蛋白质功能的工程化调控。
---

## 摘要
氧化化学是许多内源性信号通路的基础，但作为一种在活细胞中调节蛋白质功能的可编程策略，其应用仍未得到充分开发。在此，我们通过将光敏剂与特定的细胞内环境耦合，建立了一种遗传编码的氧化化学作为调节多种蛋白质的可调控框架。利用 miniSOG 产生活性氧（ROS），我们展示了受控的细胞内氧化增强了氧化还原报告蛋白 HyPerRed 的荧光，并激活了氧化还原敏感的 TRP 离子通道，其中 TRPA1 和 TRPV1 反应强烈，而 TRPV4 则没有。通路选择性清除剂揭示了可溶性靶点和膜靶点与不同氧化过程的差异化耦合，支持了基于环境而非统一氧化扰动的选择性。调节强度和动力学可通过光照参数、表达比例和亚细胞定位进行定量调节，其中膜靶向增强了与膜效应器的耦合。最后，将 miniSOG 融合靶向至 TRPV1 以及对人成纤维细胞中内源性 TRPA1 的调节，将该方法扩展到了蛋白质近端和天然细胞环境。总之，这些结果将遗传编码的氧化化学定位为一种多功能且具有空间组织性的模式，用于在定义的运行机制内工程化活细胞中的蛋白质功能。
